...
export const STRINGS = {
  uk: {
    ...
    pr_title: 'Проекти',
    pr_desc: 'Джерела синхронізації: проекти TimeCamp і Jira. Увімкніть, що потрапляє в синк.',
  ...
  en: {
    ...
    pr_title: 'Projects',
    pr_desc: 'Sync sources: TimeCamp and Jira projects. Toggle what flows into sync.',
