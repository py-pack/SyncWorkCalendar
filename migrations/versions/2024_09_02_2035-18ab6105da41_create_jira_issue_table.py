...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("jr_creator_id", sa.Integer(), nullable=True),
        sa.Column("jr_reporter_id", sa.Integer(), nullable=True),
    ...
    op.create_index(
        op.f("ix_jr_issues_jr_creator_id"),
        "jr_issues",
        ["jr_creator_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_jr_issues_jr_reporter_id"),
        "jr_issues",
        ["jr_reporter_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(op.f("ix_jr_issues_jr_reporter_id"), table_name="jr_issues")
    op.drop_index(op.f("ix_jr_issues_jr_project_id"), table_name="jr_issues")
    op.drop_index(op.f("ix_jr_issues_jr_creator_id"), table_name="jr_issues")
